...
function c(e8, u5, c10) {
  var i5 = this, a6 = (0, import_react17.useRef)(null), o5 = (0, import_react17.useRef)(0), f2 = (0, import_react17.useRef)(null), l5 = (0, import_react17.useRef)([]), v3 = (0, import_react17.useRef)(), m3 = (0, import_react17.useRef)(), d5 = (0, import_react17.useRef)(e8), g2 = (0, import_react17.useRef)(true);
  d5.current = e8;
  ...
  var A4 = (0, import_react17.useMemo)(function() {
    var r5 = function(r6) {
      var n7 = l5.current, t8 = v3.current;
      return l5.current = v3.current = null, o5.current = r6, m3.current = d5.current.apply(t8, n7);
    }, n6 = function(r6, n7) {
      w3 && cancelAnimationFrame(f2.current), f2.current = w3 ? requestAnimationFrame(r6) : setTimeout(r6, n7);
    }, t7 = function(r6) {
      if (!g2.current) return false;
      var n7 = r6 - a6.current;
      return !a6.current || n7 >= u5 || n7 < 0 || h2 && r6 - o5.current >= F2;
    }, e9 = function(n7) {
      return f2.current = null, x3 && l5.current ? r5(n7) : (l5.current = v3.current = null, m3.current);
    }, c11 = function r6() {
      var c12 = Date.now();
      if (t7(c12)) return e9(c12);
      if (g2.current) {
        var i6 = u5 - (c12 - a6.current), f3 = h2 ? Math.min(i6, F2 - (c12 - o5.current)) : i6;
        n6(r6, f3);
      }
    }, A5 = function() {
      if (p4 || y5) {
        var e11 = Date.now(), d6 = t7(e11);
        if (l5.current = [].slice.call(arguments), v3.current = i5, a6.current = e11, d6) {
          if (!f2.current && g2.current) return o5.current = a6.current, n6(c11, u5), s6 ? r5(a6.current) : m3.current;
          if (h2) return n6(c11, u5), r5(a6.current);
        }
        return f2.current || n6(c11, u5), m3.current;
      }
    };
    return A5.cancel = function() {
      f2.current && (w3 ? cancelAnimationFrame(f2.current) : clearTimeout(f2.current)), o5.current = 0, l5.current = a6.current = v3.current = f2.current = null;
    }, A5.isPending = function() {
      return !!f2.current;
    }, A5.flush = function() {
      return f2.current ? e9(Date.now()) : m3.current;
    }, A5;
...
function a(n6, t7, a6) {
  var o5 = a6 && a6.equalityFn || i2, f2 = (0, import_react17.useRef)(n6), l5 = (0, import_react17.useState)({})[1], v3 = c((0, import_react17.useCallback)(function(r5) {
    f2.current = r5, l5({});
  }, [l5]), t7, a6), m3 = (0, import_react17.useRef)(n6);
...
//# sourceMappingURL=chunk-PUPZ4IKR.js.map
